...
/*		객체지향언어
		...
		3. 신뢰성이 높은 프로그래밍을 가능케 한다 - 제어자와 메서드를 이용해서 데이터를 보호하고 올바른 값을 유지토록 하며, 
		...
		객체(Object) - 물건, 목표, 개념(시간, 사계절 등등),실제로 존재하는 것.
	
		객체란 실제로 존재하는 것. 사물 또는 개념.
		객체의 용도 - 객체가 가지고 있는 기능과 속성에 따라 다름.
		
		유형의 객체 - 책상, 의자, 자동차 등과 같은 사물
		무형의 객체 - 수학공식, 시간, 기온 등과 같은 논리나 개념.
		...
		배열 - 같은 종류의 여러 데이터를 하나의 집합으로저장할 수 있는 공간
		구조체 - 서로 관련된 여러 데이터를 종류에 관계없이 하나의 집합으로 저장할 수 있는 공간
		클래스(=사용자 정의 타입) - 데이터와 함수의 결합(구조체 + 함수) %매서드 = 함수
*/
