	...
	<div style="width: 675px;">
		...
		<div>	
			<table style="margin-bottom: 10px;">
				...
				<tr>
					<td style="width: 165px;">&emsp;&emsp;.&emsp;&emsp;.&emsp;&emsp;~&emsp;&emsp;.</td>
			...
			<table style="margin-right: 5px; margin-bottom: 10px; float: left;
			 height: 130px;">
				<tr>
					...
					<th class="header" style="width: 40px;">관계</th>
					<th class="header" style="width: 75px;">성명</th>
					<th class="header" style="width: 40px;">연령</th>
					<th class="header" style="width: 90px;">근무처</th>
					<th class="header" style="width: 55px;">직위</th>
					<th class="header" style="width: 60px;">동거</th>
				</tr>
				<tr>
		...
		<div>	
			<table style="margin-bottom: 10px; float: left; height: 90px;">
				<tr>
					<th rowspan="6" style="background-color: #CF3682; width: 30px;">
						<b>외<br><br>국<br><br>어</b>
					</th>
					<th style="width: 60px; height: 15px;">언&emsp;어</th>
					<th style="width: 80px; height: 15px;">능&emsp;력</th>
				</tr>
				<tr>
					<td style="width: 60px; height: 15px;">영어</td>
					<td style="width: 80px; height: 15px;">상&emsp;중&emsp;하</td>
				</tr>
				<tr>
				...
				<tr>
					<td style="width: 60px; height: 15px;">공인시험</td>
					<td style="width: 80px; height: 15px;">점&emsp;수</td>
				</tr>
				<tr>
					<td style="width: 60px; height: 15px;"></td>
					<td style="width: 80px; height: 15px;"></td>
		...
		<div>
			<table style="margin-right: 5px; margin-bottom: 10px; float: left;">
				<tr>
					...
					<td style="width: 190px;">워드&emsp;(한글/MS워드)</td>
					<td style="width: 70px;">상&emsp;중&emsp;하</td>
				</tr>
				<tr>
					<td style="width: 190px;">프레젠테이션&emsp;(파워포인트)</td>
					<td style="width: 70px;">상&emsp;중&emsp;하</td>
				</tr>
				<tr>
					<td style="width: 190px;">스프레드시트&emsp;(엑셀)</td>
					<td style="width: 70px;">상&emsp;중&emsp;하</td>
				</tr>
				<tr>
					<td style="width: 190px;">인터넷활용</td>
					<td style="width: 70px;">상&emsp;중&emsp;하</td>
				</tr>	
			</table>
			<table style="margin-bottom: 10px; float: left;">
				<tr>
					...
					<td style="width: 75px;">취득일자</td>
					<td style="width: 165px;">종&emsp;&emsp;류</td>
					<td style="width: 30px;">등급</td>
				</tr>
				<tr>
					<td style="width: 75px;">&emsp;&emsp;.&emsp;&emsp;.&emsp;&emsp;</td>
					<td style="width: 165px;"></td>
