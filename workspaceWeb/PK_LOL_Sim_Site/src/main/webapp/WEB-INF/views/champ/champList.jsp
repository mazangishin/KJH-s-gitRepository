...
<div id="container">
	...
	<div id="championBox">
		<c:forEach var="champImage" items="fileList" varStatus="status">
			<div class="championArt">
				<a href="/champ/champDetailView?championNumber=
				${champList[status.count].championNumber}">
					<img src="${stored_flie_name}" width="300" height="300">
				</a>
			</div>
		</c:forEach>
	</div>
