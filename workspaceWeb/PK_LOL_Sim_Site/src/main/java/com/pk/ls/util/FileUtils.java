...
public class FileUtils {
	...
	private static final String filePath = "C:\\champion";

//	int parentSeq는 파일이 담겨진 테이블의 기본키값이다
	public List<Map<String, Object>> parseInsertFileInfo(int championNumber,
		...
		while (iterator.hasNext()) {
			...
			if (multipartFile.isEmpty() == false) {
				...
				fileInfoMap.put("championNumber", championNumber);
